...
class AllTrackedDailyHabit(Static):
    ...
    def __init__(self,u,apii):
        ...
        self.list_of_habitid = self.hapi.daily_list_of_a_user_habits(self.userList[0])

        self.listLen=len(self.list_of_habitid)
        self.table = DataTable(id='all_daily_habit')
    ...
    def compose(self) -> ComposeResult:
        if self.listLen==0:
            yield ZeroDisplay("No Daily habit registered yet")
        else:
            ...
            yield Header1('ALL CURRENTLY TRACKED Daily HABITS')
            yield self.table
    ...
    def on_mount(self) -> None:
        if self.listLen == 0:
            ...
            table = self.query_one('#all_daily_habit')
